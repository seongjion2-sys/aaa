    ...
    "1세대 (관동)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "desc": "관동 사천왕의 첫 번째 주자로, 냉정하고 침착하게 얼음 포켓몬을 다루는 트레이너입니다.",
            ...
            },
            {
                ...
                "desc": "다부진 체격으로 격투 포켓몬을 단련시키는 관동 사천왕입니다.",
                "pokemon": ["롱스톤", "홍수몬", "시라소몬", "괴력몬"],
                "image": "",
            },
            {
                "name": "국화",
                ...
                "desc": "신비로운 분위기를 풍기며 고스트 포켓몬을 다루는 관동 사천왕입니다.",
                "pokemon": ["팬텀", "골뱃", "아보크", "헬가"],
                "image": "",
            },
            {
                "name": "목호",
                ...
                "desc": "관동 사천왕의 마지막 주자로, 강력한 드래곤 포켓몬을 다루는 트레이너입니다. 이후 성도지방으로 건너가 챔피언 자리에까지 오릅니다.",
                "pokemon": ["갸라도스", "신뇽", "프테라", "망나뇽"],
                "image": "",
            },
            {
                "name": "그린",
    ...
    "2세대 (성도)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "type": "기타",
                "specialty": "포켓몬 연구",
                "desc": "떡갈나무마을에 연구소를 두고, 주인공에게 성도지방의 스타팅 포켓몬을 나눠주는 박사입니다.",
                "pokemon": [],
                "image": "",
            },
            {
                ...
                "type": "에스퍼",
                "specialty": "에스퍼 타입 포켓몬 전문",
                "desc": "성도 사천왕의 첫 번째 주자로, 에스퍼 포켓몬을 능숙하게 다루는 트레이너입니다.",
                "pokemon": ["네이티오", "나시", "야도란", "루주라"],
                "image": "",
            },
            {
                "name": "독수",
                ...
                "type": "독",
                "specialty": "독 타입 포켓몬 전문",
                "desc": "연분홍시티 체육관 관장에서 물러난 뒤, 성도 사천왕으로 활동하게 된 인물입니다.",
                "pokemon": ["아리아도스", "쏘콘", "질뻐기", "도나리", "크로뱃"],
                "image": "",
            },
            {
                "name": "시바",
                ...
                "type": "격투",
                "specialty": "격투 타입 포켓몬 전문",
                "desc": "관동 사천왕 시절부터 이어 성도리그에서도 격투 포켓몬으로 활약하는 사천왕입니다.",
                "pokemon": ["카포에라", "홍수몬", "시라소몬", "롱스톤", "괴력몬"],
                "image": "",
            },
            {
                "name": "카렌",
                "title": "성도리그 사천왕",
                "type": "악",
                "specialty": "악 타입 포켓몬 전문",
                "desc": "성도 사천왕의 마지막 주자로, 악 타입 포켓몬을 앞세운 노련한 트레이너입니다.",
                "pokemon": ["블래키", "라플레시아", "니로우", "팬텀", "헬가"],
                "image": "",
            },
        ],
    },
    "3세대 (호연)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "type": "기타",
                "specialty": "포켓몬 연구",
                "desc": "포켓몬의 서식과 분포를 연구하며, 주인공에게 호연지방의 스타팅 포켓몬을 나눠주는 박사입니다.",
                "pokemon": [],
                "image": "",
            },
            {
                ...
                "type": "악",
                "specialty": "악 타입 포켓몬 전문",
                "desc": "호연 사천왕의 첫 번째 주자로, 거침없는 악 타입 포켓몬을 사용하는 트레이너입니다.",
                "pokemon": ["그라에나", "다탱구", "밤선인", "샤크니아", "앱솔"],
                "image": "",
            },
            {
                "name": "회연",
                ...
                "type": "고스트",
                "specialty": "고스트 타입 포켓몬 전문",
                "desc": "고요한 분위기 속에서 고스트 포켓몬을 다루는 호연 사천왕입니다.",
                "pokemon": ["미라몽", "다크펫", "깜까미", "야느와르몽"],
                "image": "",
            },
            {
                "name": "미혜",
                ...
                "type": "얼음",
                "specialty": "얼음 타입 포켓몬 전문",
                "desc": "차분한 성격으로 얼음 포켓몬을 다루는 호연 사천왕입니다.",
                "pokemon": ["얼음귀신", "씨레오", "씨카이저", "눈여아"],
                "image": "",
            },
            {
                "name": "권수",
                ...
                "type": "드래곤",
                "specialty": "드래곤 타입 포켓몬 전문",
                "desc": "호연 사천왕의 마지막 주자로, 강력한 드래곤 포켓몬을 다루는 트레이너입니다.",
                "pokemon": ["쉘곤", "파비코리", "플라이곤", "킹드라", "보만다"],
                "image": "",
            },
            {
                "name": "스틸",
                ...
                "type": "강철",
                "specialty": "강철 타입 포켓몬 전문",
                "desc": "돌과 보석을 좋아하는 애호가로, 호연지방 최초의 챔피언에 오른 인물입니다.",
                "pokemon": ["보스로라", "쟁쿠토르", "쥬레곤", "커다코", "쨈고둥", "보크레키온"],
                "image": "",
            },
        ],
    },
    "4세대 (신오)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "type": "기타",
                "specialty": "포켓몬 연구",
                "desc": "신화마을에 연구소를 두고, 주인공에게 신오지방의 스타팅 포켓몬을 나눠주는 박사입니다.",
                "pokemon": [],
                "image": "",
            },
            {
                ...
                "type": "벌레",
                "specialty": "벌레 타입 포켓몬 전문",
                "desc": "신오 사천왕의 첫 번째 주자로, 벌레 포켓몬을 정예로 키워낸 트레이너입니다.",
                "pokemon": ["독케일", "뷰티플라이", "헤라크로스", "비퀸", "드래피온"],
                "image": "",
            },
            {
                "name": "들국화",
                ...
                "desc": "듬직한 인상으로 땅 포켓몬을 다루는 신오 사천왕입니다.",
                "pokemon": ["누오", "꼬지모", "메깅", "글라이온", "하마돈", "거대코뿌리"],
                "image": "",
            },
            {
                "name": "대엽",
                ...
                "type": "불꽃",
                "specialty": "불꽃 타입 포켓몬 전문",
                "desc": "스토리 중반에 주인공과 자주 마주치며 존재감을 드러내는 불꽃 타입 사천왕입니다.",
                "pokemon": ["헬가", "부스터", "날쌩마", "초염몽", "마그마번"],
                "image": "",
            },
            {
                "name": "오엽",
                ...
                "type": "에스퍼",
                "specialty": "에스퍼 타입 포켓몬 전문",
                "desc": "신오 사천왕의 마지막 주자로, 에스퍼 포켓몬을 다루는 트레이너입니다.",
                "pokemon": ["마임맨", "에브이", "동탁군", "후딘", "엘레이드"],
                "image": "",
            },
        ],
    },
    "5세대 (하나)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "type": "기타",
                "specialty": "포켓몬 연구",
                "desc": "포켓몬 시리즈 최초의 여성 박사로, 마름꽃마을에서 포켓몬의 기원과 행동을 연구합니다.",
                "pokemon": [],
                "image": "",
            },
            {
                ...
                "type": "고스트",
                "specialty": "고스트 타입 포켓몬 전문",
                "desc": "하나 사천왕의 첫 번째 주자로, 고스트 포켓몬을 다루는 트레이너입니다.",
                "pokemon": ["데스니칸", "탱탱겔", "골루그", "샹델라"],
                "image": "",
            },
            {
                "name": "연무",
                ...
                "type": "격투",
                "specialty": "격투 타입 포켓몬 전문",
                "desc": "우락부락한 인상과 달리 사천왕의 중립 원칙을 성실히 지키는 격투 타입 사천왕입니다.",
                "pokemon": ["던지미", "타격귀", "노보청", "비조도"],
                "image": "",
            },
            {
                "name": "카틀레야",
                ...
                "type": "에스퍼",
                "specialty": "에스퍼 타입 포켓몬 전문",
                "desc": "우아한 분위기로 에스퍼 포켓몬을 다루는 하나 사천왕입니다.",
                "pokemon": ["몽얌나", "란쿨루스", "심보러", "고디모아젤"],
                "image": "",
            },
            {
                "name": "블래리",
                ...
                "type": "악",
                "specialty": "악 타입 포켓몬 전문",
                "desc": "하나 사천왕의 마지막 주자로, 악 타입 포켓몬을 다루는 트레이너입니다.",
                "pokemon": ["곤율거니", "악비아르", "레파르다스", "절각참"],
                "image": "",
            },
        ],
    },
    "6세대 (칼로스)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "type": "기타",
                "specialty": "포켓몬 연구",
                "desc": "메가진화를 연구하는 박사로, 주인공에게 칼로스지방의 스타팅 포켓몬을 나눠줍니다.",
                "pokemon": [],
                "image": "",
            },
            {
                ...
                "type": "물",
                "specialty": "물 타입 포켓몬 전문",
                "desc": "칼로스 사천왕의 첫 번째 주자로, 메가진화 갸라도스를 앞세우는 트레이너입니다.",
                "pokemon": ["갸라도스", "장크로다일", "라이보르트", "메가거북왕"],
                "image": "",
            },
            {
                "name": "간피",
                ...
                "type": "강철",
                "specialty": "강철 타입 포켓몬 전문",
                "desc": "메가진화 핫삼을 다루는 강철 타입 전문 칼로스 사천왕입니다.",
                "pokemon": ["핫삼", "너트령", "메탕그", "메가핫삼"],
                "image": "",
            },
            {
                "name": "드라세나",
                ...
                "type": "드래곤",
                "specialty": "드래곤 타입 포켓몬 전문",
                "desc": "메가진화 파비코리를 다루는 드래곤 타입 전문 칼로스 사천왕입니다.",
                "pokemon": ["파비코리", "미뇽", "보만다", "메가파비코리"],
                "image": "",
            },
            {
                "name": "파키라",
                ...
                "type": "불꽃",
                "specialty": "불꽃 타입 포켓몬 전문",
                "desc": "칼로스 사천왕의 마지막 주자로, 강렬한 불꽃 포켓몬을 다루는 트레이너입니다.",
                "pokemon": ["윈디", "헬가", "마그마번", "부스터"],
                "image": "",
            },
        ],
    },
    "7세대 (알로라)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "title": "알로라지방 포켓몬 박사",
                "type": "격투",
                "specialty": "포켓몬 연구 및 배틀 스타일 분석",
                "desc": "가면을 쓴 프로레슬러로도 활동하는 알로라지방의 포켓몬 박사로, 울트라썬·울트라문에서는 알로라리그 챔피언도 겸임합니다.",
                "pokemon": ["브로치리"],
                "image": "",
            },
            {
                ...
                "type": "바위",
                "specialty": "바위 타입 포켓몬 전문",
                "desc": "알로라 최초의 바위 타입 사천왕으로, 온화한 성격의 트레이너입니다.",
                "pokemon": ["루가루암", "이와크", "코팡", "무장조"],
                "image": "",
            },
            {
                "name": "아세로라",
                ...
                "type": "고스트",
                "specialty": "고스트 타입 포켓몬 전문",
                "desc": "섬의 캡틴 출신으로, 고스트 포켓몬과 교감하는 알로라 사천왕입니다.",
                "pokemon": ["미미로프", "다크펫", "무우마직", "라플레시아"],
                "image": "",
            },
            {
                "name": "카일리",
                ...
                "type": "비행",
                "specialty": "비행 타입 포켓몬 전문",
                "desc": "알로라 최초의 비행 타입 사천왕으로, 프로 골프 선수로도 활동합니다.",
                "pokemon": ["부우부", "코스모스", "탐타뮤", "파오리"],
                "image": "",
            },
            {
                "name": "멀레인",
                ...
                "type": "강철",
                "specialty": "강철 타입 포켓몬 전문",
                "desc": "천문대 연구원으로도 활동하는 강철 타입 전문 알로라 사천왕입니다.",
                "pokemon": ["메탕그", "너트령", "긴상강", "핫삼"],
                "image": "",
            },
            {
                "name": "하우",
                ...
                "type": "풀",
                "specialty": "올라운더",
                "desc": "주인공의 둘도 없는 친구이자 라이벌로, 훗날 알로라지방을 대표하는 정식 챔피언으로 성장하는 인물입니다.",
                "pokemon": ["브케인", "나무돌이", "픽시", "망나뇽", "잠만보", "리자몽"],
                "image": "",
            },
        ],
    },
    "8세대 (가라르)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "title": "가라르지방 포켓몬 박사",
                "type": "기타",
                "specialty": "다이맥스 현상 연구",
                "desc": "다이맥스 현상을 연구하는 원로 박사로, 손녀 소니아와 함께 가라르지방의 스타팅 포켓몬을 관리합니다. 가라르지방에는 별도의 사천왕 제도 없이, 첫 챔피언스컵 토너먼트에서 체육관 관장들과의 재대결로 그 역할을 대신합니다.",
                "pokemon": [],
                "image": "",
            },
        ],
    ...
    "9세대 (팔데아)": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "title": "팔데아지방 포켓몬 박사",
                "type": "기타",
                "specialty": "포켓몬 고대·미래 연구",
                "desc": "에리어 제로를 연구하는 박사로, 스칼렛에서는 투로박사, 바이올렛에서는 올림박사로 등장하는 버전 한정 인물입니다.",
                "pokemon": [],
                "image": "",
            },
            {
                ...
                "type": "땅",
                "specialty": "땅 타입 포켓몬 전문",
                "desc": "사천왕의 실질적인 총무 역할을 도맡는, 붙임성 좋은 땅 타입 전문 사천왕입니다.",
                "pokemon": ["토오", "니드킹", "고지", "코뿌리"],
                "image": "",
            },
            {
                "name": "뽀삐",
                ...
                "type": "강철",
                "specialty": "강철 타입 포켓몬 전문",
                "desc": "역대 최연소 사천왕으로, 어린 나이에도 강철 포켓몬을 능숙하게 다루는 트레이너입니다.",
                "pokemon": ["네리네", "긴상강", "메탕구", "코일"],
                "image": "",
            },
            {
                "name": "팔자크",
                ...
                "type": "드래곤",
                "specialty": "드래곤 타입 포켓몬 전문",
                "desc": "팔데아 사천왕의 정식 리더이자, 아카데미 미술 교사로도 활동하는 감정 풍부한 트레이너입니다.",
                "pokemon": ["파비코리", "미뇽", "한카리아스", "보만다"],
                "image": "",
            },
            {
                "name": "테사",
                "title": "팔데아리그 치프 챔피언",
                "type": "기타",
                "specialty": "리그 운영 및 올라운더",
                "desc": "팔데아리그 위원장을 겸임하는 치프 챔피언으로, 다른 지방 챔피언보다 더 많은 권한과 업무를 갖고 있습니다.",
                "pokemon": ["다부니", "글리마", "키류다"],
                "image": "",
            },
        ],
    ...
    "히스이 지방": {
        ...
        "characters": [
            ...
            },
            {
                ...
                "type": "기타",
                "specialty": "포켓몬 생태 연구",
                "desc": "타지에서 건너와 히스이지방에 정착한 학자로, 은하단 조사대를 학술적으로 지원하며 전국 최초의 포켓몬 도감 편찬을 돕습니다. 히스이지방은 체육관·사천왕·챔피언 제도가 아직 없던 시기라, 별도의 리그 인물은 존재하지 않습니다.",
                "pokemon": [],
                "image": "",
            },
        ],
...
# 인물 도감 표시 순서 (주인공 → 라이벌 → 포켓몬 박사 → 체육관 관장 → 사천왕·챔피언 → 로켓단)
# 챔피언과 사천왕은 하나의 카테고리로 묶어서 표시합니다.
...
def get_character_category(char):
  ...
  title = char["title"]
  if "사천왕" in title or "챔피언" in title:
    return "사천왕·챔피언"
  if "박사" in title:
    return "포켓몬 박사"
  if "체육관" in title or "스타디움" in title:
    return "체육관 관장"
  return "기타"
...
# PokeAPI에 한국어는 물론 영어 도감 설명조차 등록되어 있지 않거나,
# 번역 API가 계속 실패하는 일부 포켓몬을 위한 수동 보강 설명.
# (닌텐도의 공식 도감 문구를 그대로 옮긴 것이 아니라, 직접 작성한 설명입니다.)
MANUAL_FLAVOR_OVERRIDES = {
    899: (  # 신비록 (Wyrdeer)
        "옛날부터 인간과 마음을 나눠 온 사슴록이, 히스이지방의 혹독한 자연 속에서 "
        "신비한 힘에 눈떠 진화한 모습입니다. 위엄 있게 뻗은 뿔은 신비한 힘의 "
        "원천으로 알려져 있으며, 무리를 이끄는 리더 역할을 합니다."
    ),
}
...
def extract_single_flavor_text(species_data):
  ...
  if pokemon_id in MANUAL_FLAVOR_OVERRIDES:
    return MANUAL_FLAVOR_OVERRIDES[pokemon_id]
